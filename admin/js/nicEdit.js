...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'left' : {name : __('Aliniere Stanga'), command : 'justifyleft', noActive : true},
		'center' : {name : __('Aliniere Centru'), command : 'justifycenter', noActive : true},
		'right' : {name : __('Aliniere Dreapta'), command : 'justifyright', noActive : true},
		'justify' : {name : __('Aliniere Justify'), command : 'justifyfull', noActive : true},
		'ol' : {name : __('Insereaza Lista Ordonata'), command : 'insertorderedlist', tags : ['OL']},
		'ul' : 	{name : __('Insereaza Lista'), command : 'insertunorderedlist', tags : ['UL']},
		'subscript' : {name : __('Subscript'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('Superscript'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('Strike'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('Scoate Formatting'), command : 'removeformat', noActive : true},
		'indent' : {name : __('Indent Text'), command : 'indent', noActive : true},
		'outdent' : {name : __('Scoate Indent'), command : 'outdent', noActive : true},
		'hr' : {name : __('Linie Orizontala'), command : 'insertHorizontalRule', noActive : true}
	},
...
var nicSelectOptions = {
	buttons : {
		'fontSize' : {name : __('Selecteaza Marime Font'), type : 'nicEditorFontSizeSelect', command : 'fontsize'},
		'fontFamily' : {name : __('Selecteaza Tip Font'), type : 'nicEditorFontFamilySelect', command : 'fontname'},
		'fontFormat' : {name : __('Selecteaza Format Font'), type : 'nicEditorFontFormatSelect', command : 'formatBlock'}
	}
};
/* END CONFIG */
...
var nicLinkOptions = {
	buttons : {
		'link' : {name : 'Adauga Link', type : 'nicLinkButton', tags : ['A']},
		'unlink' : {name : 'Scoate Link',  command : 'unlink', noActive : true}
	}
};
/* END CONFIG */
...
var nicLinkButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			...
			'title' : {type : 'text', txt : 'Titlu'},
			'target' : {type : 'select', txt : 'Deschide In', options : {'' : 'Fereastra Curenta', '_blank' : 'Fereastra Noua'},style : {width : '100px'}}
		},this.ln);
	},
	...
	submit : function(e) {
		...
		if(url == "http://" || url == "") {
			alert("Trebuie sa introduceti un link");
			return false;
		}
		this.removePane();
...
var nicColorOptions = {
	buttons : {
		'forecolor' : {name : __('Schimba Culoare Text'), type : 'nicEditorColorButton', noClose : true},
		'bgcolor' : {name : __('Schimba Culoare Fundal'), type : 'nicEditorBgColorButton', noClose : true}
	}
};
/* END CONFIG */
...
var nicImageOptions = {
	buttons : {
		'image' : {name : 'Adauga Imagine', type : 'nicImageButton', tags : ['IMG']}
	}
...
var nicImageButton = nicEditorAdvancedButton.extend({	
	...
	submit : function(e) {
		...
		if(src == "" || src == "http://") {
			alert("Trebuie sa introduceti URL-ul imaginii");
			return false;
		}
		this.removePane();
...
var nicSaveOptions = {
	buttons : {
		'save' : {name : __('Salveaza continut'), type : 'nicEditorSaveButton'}
	}
};
/* END CONFIG */
...
var nicUploadOptions = {
	buttons : {
		'upload' : {name : 'Incarca Imagine', type : 'nicUploadButton'}
	}
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
  ...
  errorText : 'Nu sa putut incarca imaginea',

	addPane : function() {
    if(typeof window.FormData === "undefined") {
      return this.onError("Incarcarea imaginilor nu este suportata in acest browser folositi Chrome, Firefox, sau Safari");
    }
    this.im = this.ne.selectedInstance.selElm().parentTag('IMG');
    ...
    var container = new bkElement('div')
      ...
      .setContent('Incarcati o imagine')
      .appendTo(container);
  ...
  onError : function(msg) {
    this.removePane();
    alert(msg || "Nu sa putut incarca imagine");
  },

  uploadFile : function() {
    var file = this.fileInput.files[0];
    if (!file || !file.type.match(/image.*/)) {
      this.onError("Doar imagini se pot incarca");
      return;
    }
...
var nicCodeOptions = {
	buttons : {
		'xhtml' : {name : 'Editeaza HTML', type : 'nicCodeButton'}
	}
